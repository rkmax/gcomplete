		...
		gcomplete: function(option)
		{
			...
			var _tag = _self.get(0).tagName.toLowerCase();
				...
				function cleanText(text) {
					var fullStr = text;
        		    var left_trimmedStr = fullStr.replace(this.initial_whitespace_rExp, "");
		            var cleanedStr = left_trimmedStr.replace(this.non_alphanumerics_rExp, " ");
				...
				function getLastWord() {
					var word_count = 0,
            			...
            			return (splitString.length > 0 ? splitString[splitString.length -1] : null);
				}				
